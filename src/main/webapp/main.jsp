...
<link rel="stylesheet" href="<%=request.getContextPath() %>/css/cyworld_member_layout.css?after" />
</head>
<body>
<div>
	<p id="img_id" align="center"><img src="../images/logo.png" width="280" height="80"></p>
	<h2>회원 전용 페이지</h2>
	<!-- 로그인이 완료된 후 이동하는 페이지 -->
		...
		<table>
			...
			<tr>
				...
				<td colspan="2" align="center">
					...
					<input type="button" value = "싸이월드 홈피로 이동" onclick = "location.href = '../home/home.do'">
					<!-- 싸이월드 홈 페이지로 이동. -->
				</td>
			</tr>
		</table>
