				...
				<div class="home">
					...
					<div class="home_main">
						...
						<div class="home_contents">
							...
							<div class="visit_contents" style = "margin-top:30px;">
		...
		<form method="post" encType = "multipart/form-data" action="commentAction.jsp?bbsID=${userid}&boardID=${userid}">
			<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
				<tr>
					...
					<td><input type="text" style=" width:550px; height:70px;" class="form-control" placeholder="댓글을 써주세요." name = "commentText"></td>
...
<input type = "button" value = "방명록 등록" style = "margin-top:50px; margin-left:550px; width:100px;" onclick = "location.href = '../visit/visitWrite.do'">
